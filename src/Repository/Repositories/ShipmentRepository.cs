            ...
            .Select(parcel => new Parcel
            {
                ...
                CategoryInsurance = new CategoryInsurance
                {
                    ...
                    InsurancePolicy = new InsurancePolicy
                    {
                        ...
                        MaxInsuranceRateOnValue = parcel.CategoryInsurance.InsurancePolicy.MaxInsuranceRateOnValue,
                        MinInsuranceRateOnValue = parcel.CategoryInsurance.InsurancePolicy.MinInsuranceRateOnValue,
