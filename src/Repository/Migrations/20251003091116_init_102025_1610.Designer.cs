...
namespace MetroShip.Repository.Migrations
{
    ...
    [Migration("20251003091116_init_102025_1610")]
    partial class init_102025_1610
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MetroShip.Repository.Models.DistanceTier", b =>
                {
                    ...
                    b.Property<decimal?>("BasePriceVnd")
            ...
            modelBuilder.Entity("MetroShip.Repository.Models.MetroLine", b =>
                {
                    ...
                    b.Property<string>("StationListJSON")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("MetroShip.Repository.Models.Parcel", b =>
                {
                    ...
                    b.Property<decimal?>("CompensationFeeVnd")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("MetroShip.Repository.Models.ParcelMedia", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");

                    b.Property<int>("BusinessMediaType")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MetroShip.Repository.Models.Shipment", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("FeedbackRespondedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<decimal?>("TotalCompensationFeeVnd")
                        .HasColumnType("decimal(18, 2)");
                    ...
                    b.Property<decimal?>("TotalRefundedFeeVnd")
                        .HasColumnType("decimal(18, 2)");
            ...
            modelBuilder.Entity("MetroShip.Repository.Models.Station", b =>
                {
                    ...
                    b.Property<string>("StationCodeListJSON")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("MetroShip.Repository.Models.SupportTicket", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("MetroShip.Repository.Models.WeightTier", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.Property<decimal?>("BasePriceVndPerKmPerKg")
                        .HasColumnType("numeric");
                    ...
                    b.Property<bool>("IsPricePerKmAndKg")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("MetroShip.Repository.Models.SupportTicket", b =>
                {
                    b.HasOne("MetroShip.Repository.Models.Identity.UserEntity", "OpenBy")
                        .WithMany("OpenedSupportTickets")
                        .HasForeignKey("OpenById")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MetroShip.Repository.Models.Identity.UserEntity", "ResolvedBy")
                        .WithMany("ResolvedSupportTickets")
            ...
            modelBuilder.Entity("MetroShip.Repository.Models.Identity.UserEntity", b =>
                {
                    ...
                    b.Navigation("OpenedSupportTickets");

                    b.Navigation("Reports");

                    b.Navigation("ResolvedSupportTickets");
