namespace MetroShip.Service.ApiModels.User
{
    public sealed record RegisterRequest
    {
        ...
        public string? Avatar { get; set; } = "https://static.vecteezy.com/system/resources/thumbnails/009/292/244/small_2x/default-avatar-icon-of-social-media-user-vector.jpg";
